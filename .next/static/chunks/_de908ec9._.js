...
"[project]/app/utils/constants.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    "ENDPOINT": (()=>ENDPOINT),
    "MAX_CANDIDATE_NAME_LENGTH": (()=>MAX_CANDIDATE_NAME_LENGTH),
...
;
const PROGRAM_ID = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PublicKey"]('C82ywxcsy6SahTq2CvdnGsN4xN1aKeWan7VR3mDQgi8V');
const NETWORK = 'devnet';
const ENDPOINT = 'https://api.devnet.solana.com';
const MAX_DESCRIPTION_LENGTH = 280;
const MAX_CANDIDATE_NAME_LENGTH = 32;
...
;
;
const createProgramInstance = (idl, programId, provider)=>{
    // Force cast the IDL to the expected type
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$project$2d$serum$2f$anchor$2f$dist$2f$browser$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Program"](idl, programId, provider);
};
const useVotingProgram = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useVotingProgram.useEffect": ()=>{
            if (wallet) {
                ...
                try {
                    if (!__TURBOPACK__imported__module__$5b$project$5d2f$target$2f$idl$2f$solana_voting_app$2e$json__$28$json$29$__["default"] || typeof __TURBOPACK__imported__module__$5b$project$5d2f$target$2f$idl$2f$solana_voting_app$2e$json__$28$json$29$__["default"] !== 'object') {
                        throw new Error('IDL file is not properly loaded');
                    }
                    // Check essential IDL properties
                    if (!Array.isArray(__TURBOPACK__imported__module__$5b$project$5d2f$target$2f$idl$2f$solana_voting_app$2e$json__$28$json$29$__["default"].instructions) || __TURBOPACK__imported__module__$5b$project$5d2f$target$2f$idl$2f$solana_voting_app$2e$json__$28$json$29$__["default"].instructions.length === 0) {
                        throw new Error('IDL is missing instructions');
                    }
                    const programInstance = createProgramInstance(__TURBOPACK__imported__module__$5b$project$5d2f$target$2f$idl$2f$solana_voting_app$2e$json__$28$json$29$__["default"], __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROGRAM_ID"], provider);
                    setProgram(program);
                    setStatus(null);
                } catch (err) {
    ...
    const fetchPolls = async ()=>{
        ...
        try {
            ...
            // Convert the returned data to your PollAccount type
            const formattedPolls = polls.map((item)=>{
                // First cast to unknown, then to your PollAccount type
                return {
                    publicKey: item.publicKey,
                    account: {
                        pollId: item.account.poll_id,
                        description: item.account.description,
                        pollStartTime: item.account.poll_start_time,
                        pollEndTime: item.account.poll_end_time,
                        candidateAmount: item.account.candidate_amount
                    }
                };
            });
    ...
    const fetchCandidates = async (pollId)=>{
        ...
        try {
            ...
            // Filter for candidates of this specific poll and format them
            const formattedCandidates = allCandidates.filter((candidate)=>{
                // Implement proper filtering logic here
                // Example: check if candidate belongs to this poll
                return true; // Replace with actual condition
            }).map((item)=>{
                // First cast to unknown, then to your CandidateAccount type
                return {
                    publicKey: item.publicKey,
                    account: {
                        candidateName: item.account.candidate_name,
                        candidateVotes: item.account.candidate_votes
                    }
                };
            });
    ...
    const createPoll = async (description)=>{
        ...
        try {
            ...
            await program.methods.initializePoll(pollId, description, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bn$2e$js$2f$lib$2f$bn$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BN$3e$__["BN"](now), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bn$2e$js$2f$lib$2f$bn$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BN$3e$__["BN"](oneWeekFromNow)).accounts({
    ...
    const addCandidate = async (pollId, candidateName)=>{
        ...
        try {
            ...
            // Call the initialize_candidate instruction
            await program.methods.initializeCandidate(pollId, candidateName).accounts({
                signer: wallet.publicKey,
                poll: pollPDA,
    ...
    const vote = async (pollId, candidateName)=>{
        ...
        try {
            ...
            await program.methods.vote(pollId, candidateName).accounts({
                signer: wallet.publicKey,
                poll: pollPDA,
                candidate: candidatePDA,
...
_s(useVotingProgram, "doSvgWHdYaKk0aPzVYJG9rY9elg=", false, function() {
    return [
...
//# sourceMappingURL=_de908ec9._.js.map