...
function convertIdlToCamelCase(idl) {
    ...
    const toCamelCase = (s)=>s.split(".").map(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$camelcase$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]).join(".");
