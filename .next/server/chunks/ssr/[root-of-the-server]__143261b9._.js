...
const useVotingProgram = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (wallet) {
            ...
            try {
                ...
                if (!__TURBOPACK__imported__module__$5b$project$5d2f$target$2f$idl$2f$solana_voting_app$2e$json__$28$json$29$__["default"].version || !Array.isArray(__TURBOPACK__imported__module__$5b$project$5d2f$target$2f$idl$2f$solana_voting_app$2e$json__$28$json$29$__["default"].instructions)) {
                    throw new Error('IDL is missing required properties');
                }
                const program = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$project$2d$serum$2f$anchor$2f$dist$2f$esm$2f$program$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Program"](__TURBOPACK__imported__module__$5b$project$5d2f$target$2f$idl$2f$solana_voting_app$2e$json__$28$json$29$__["default"], __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PROGRAM_ID"], provider);
                setProgram(program);
                setStatus(null);
            } catch (err) {
    ...
    const fetchCandidates = async (pollId)=>{
        ...
        try {
            ...
            // Filter for candidates of this specific poll
            // This is a simplification - in production, use proper filters
            const pollIdString = pollId.toString();
            const filteredCandidates = allCandidates.filter((candidate)=>{
                // For now, include all candidates - you'd need to implement proper filtering
                return true;
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__143261b9._.js.map