...
const useVotingProgram = ()=>{
        ...
        const checkNetwork = async ()=>{
            ...
            try {
                ...
                try {
                    ...
                    if (__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NETWORK"] === 'localnet') {
                        setStatus({
                            message: `Connection to ${__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NETWORK"]} failed. Make sure your local Solana validator is running with "solana-test-validator".`,
                            isError: true
                        });
                    } else {
                        setStatus({
    ...
    const createPoll = async (description, retryCount = 0)=>{
        ...
        try {
            ...
            const pollId = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bn$2e$js$2f$lib$2f$bn$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__BN$3e$__["BN"](pollIdStr);
...
const PollCard = ({ poll, onRefresh })=>{
    ...
    const now = Math.floor(Date.now() / 1000);
    const isActive = poll.account.pollStartTime.lte(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bn$2e$js$2f$lib$2f$bn$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__BN$3e$__["BN"](now)) && poll.account.pollEndTime.gte(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bn$2e$js$2f$lib$2f$bn$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__BN$3e$__["BN"](now));
